...
export const MOCK_LOGS: CoreLog[] = [
  ...
  {
    level: "debug",
    message: "HMR update applied to +page.svelte",
    source: "vite",
  },
  {
    level: "warn",
    message: "Deprecated API call detected in auth module",
    source: "auth",
  },
  {
    level: "error",
    message: "Unhandled rejection: fetch failed for /api/data",
    source: "fetch",
  },
  {
    level: "info",
  ...
  {
    level: "info",
    message: "Scheduled job 'cleanup-sessions' executed",
    source: "cron",
  },
  {
    level: "error",
  ...
  {
    level: "debug",
    message: "SSE connection accepted from 127.0.0.1",
    source: "sse",
  },
  {
    level: "info",
    message: "User session token refreshed successfully",
    source: "auth",
  },
  {
    level: "warn",
    message: "Rate limit approaching for IP 192.168.1.10",
    source: "ratelimit",
  },
];
